...
class NeuralNetwork:
    ...
    def train(self, inputs, targets):
        ...
        gradients.multiply_by_num(self.learning_rate)
        ...
        hidden_gradients.multiply_by_num(self.learning_rate)
...
# nn.feed_forward([0, 0])
print(nn.feed_forward([0, 0]).values)
print(nn.feed_forward([1, 1]).values)
print(nn.feed_forward([1, 0]).values)
print(nn.feed_forward([0, 1]).values)
